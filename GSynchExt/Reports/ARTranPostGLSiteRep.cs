...
namespace AR
{
    ...
    [PXProjection(typeof(SelectFrom<ARTranPost>.
    LeftJoin<CurrencyInfo>.On<CurrencyInfo.curyInfoID.IsEqual<ARTranPost.curyInfoID>>.
    LeftJoin<ARTran>.On<ARTran.lineNbr.IsEqual<ARTranPost.lineNbr>.
        And<Brackets<ARTran.tranType.IsEqual<ARTranPost.sourceDocType>.
                   And<ARTran.refNbr.IsEqual<ARTranPost.sourceRefNbr>>>.
        Or<Brackets<ARTran.tranType.IsEqual<ARTranPost.docType>.
                   And<ARTran.refNbr.IsEqual<ARTranPost.refNbr>>>>>>),
                     Persistent = false)]

    [PXCacheName("AR Document Post GL for Reports")]
    public class ARTranPostGLSiteRep : PXBqlTable ,IBqlTable
    {
        #region Keys

        public class PK : PrimaryKeyOf<ARTranPostGLSiteRep>.By<docType, refNbr, lineNbr, iD>
        {
            public static ARTranPostGLSiteRep Find(PXGraph graph, string docType, string refNbr, int? lineNbr, int? id) =>
                FindBy(graph, docType, refNbr, lineNbr, id);
        }

        public static class FK
        {
            public class Document : PX.Objects.AR.ARRegister.PK.ForeignKeyOf<ARTran>.By<docType, refNbr>
            {
            }

            public class Invoice : PX.Objects.AR.ARInvoice.PK.ForeignKeyOf<ARTran>.By<docType, refNbr>
            {
            }

            public class Payment : PX.Objects.AR.ARPayment.PK.ForeignKeyOf<ARTran>.By<docType, refNbr>
            {
            }

            public class CashSale : PX.Objects.AR.Standalone.ARCashSale.PK.ForeignKeyOf<ARTran>.By<docType, refNbr>
            {
            }

            public class SOInvoice : PX.Objects.SO.SOInvoice.PK.ForeignKeyOf<ARTran>.By<docType, refNbr>
            {
            }

            public class Branch : PX.Objects.GL.Branch.PK.ForeignKeyOf<ARTran>.By<branchID>
            {
            }

            public class CurrencyInfo : PX.Objects.CM.CurrencyInfo.PK.ForeignKeyOf<ARTran>.By<curyInfoID>
            {
            }

            public class Customer : PX.Objects.AR.Customer.PK.ForeignKeyOf<ARTran>.By<customerID>
            {
            }

            public class Account : PX.Objects.GL.Account.PK.ForeignKeyOf<ARTran>.By<accountID>
            {
            }

            public class Subaccount : PX.Objects.GL.Sub.PK.ForeignKeyOf<ARTran>.By<subID>
            {
            }
        }
        ...
        [PXDBGuidAttribute(BqlTable = typeof(ARTranPost))]
        ...
        */
        ...
        public abstract class signedRGOLAmt : PX.Data.BQL.BqlDecimal.Field<rGOLAmt>
        {
        }

        [PXDependsOnFields(typeof(rGOLAmt), typeof(sourceDocType))]
        public virtual decimal? SignedRGOLAmt => RGOLAmt * ARDocType.SignBalance(SourceDocType);
        ...
        [PXDBCalced(typeof(
            Switch<
                ...
                Case<Where<ARTranPost.type.IsEqual<ARTranPost.type.application>>,
                    PX.Data.BQL.Minus<ARTranPost.glSign>.Multiply<ARTranPost.curyDiscAmt.Add<ARTranPost.curyWOAmt>.Add<ARTranPost.curyAmt>>>>,
        ...
        [PXDBCalced(typeof(
            Switch<
                ...
                Case<Where<ARTranPost.type.IsEqual<ARTranPost.type.application>>,
                    PX.Data.BQL.Minus<ARTranPost.glSign>.Multiply<
        ...
        [PXDBCalced(typeof(
            Switch<
                ...
                Case<Where<ARTranPost.type.IsEqual<ARTranPost.type.@void>
                        .And<ARTranPost.docType.IsNotIn<ARDocType.smallCreditWO, ARDocType.smallBalanceWO>>>,
                    PX.Data.BQL.Minus<ARTranPost.curyAmt>,
        ...
        [PXDBCalced(typeof(
            Switch<
                ...
                Case<Where<ARTranPost.type.IsEqual<ARTranPost.type.@void>
                        .And<ARTranPost.docType.IsNotIn<ARDocType.smallCreditWO, ARDocType.smallBalanceWO>>>,
                    PX.Data.BQL.Minus<ARTranPost.amt>,
                Case<Where<ARTranPost.type.IsEqual<ARTranPost.type.application>.And<ARTranPost.glSign.IsEqual<short1>>>,
        ...
        [PXDBCalced(typeof(IIf<ARTranPost.type.IsEqual<ARTranPost.type.retainage>,
            PX.Data.BQL.Minus<ARTranPost.balanceSign>.Multiply<ARTranPost.glSign.Multiply<ARTranPost.curyRetainageAmt>>,
            Zero>), typeof(decimal))]
        ...
        [PXBaseCury]
        [PXDBCalced(typeof(IIf<ARTranPost.type.IsEqual<ARTranPost.type.retainage>,
            PX.Data.BQL.Minus<ARTranPost.balanceSign>.Multiply<ARTranPost.glSign.Multiply<ARTranPost.retainageAmt>>,
            Zero>), typeof(decimal))]
        ...
        [SubAccount(BqlTable = typeof(ARTran), DisplayName = "SubID ")]
